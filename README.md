...
Terrible idea for a game: but it gives us a hole to fall down. And procen bg and obstacles. And stack-based scrolling - with a 20-col wide scrolling hole using IX/IY registers as well for stack render! Game status shown in top border, leaving 6-col sides of main screen to show distance to bottom of hole. And other border tricks on title screen and the like... 
